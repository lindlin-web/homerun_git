...
export class GameMain extends Component {
    ...
    @property(Node)
    pickYourBonusArt:Node;

    @property(Node)
    pickYourBonusLabel:Node;
    ...
    start() {
        ...
        if (language.indexOf("en") != -1) {
            this.pickYourBonusArt.active = true;
            this.pickYourBonusLabel.active = false;
        } else {
            this.pickYourBonusArt.active = false;
            this.pickYourBonusLabel.active = true;
        }
