...
let NUMBERLINE:number[] = [55,74,82,94,98,111,157,158,195,199,206,217,220,236,242,250,263];
...
export class ContainerWigs extends Component {
    ...
    doneWithNodeIndex(index:string) {
    ...
    findDragNodeByIndex(index:string) {
