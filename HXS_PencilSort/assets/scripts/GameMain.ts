import { _decorator, Camera, Component, EventTouch, Input, input, instantiate, Node, Prefab, systemEvent, SystemEventType, Vec3 ,Touch, PhysicsSystem, BoxCollider, tween, Vec2} from 'cc';
...
export class GameMain extends Component {
    ...
    private initPositions = [new Vec3(-5,0,11),new Vec3(-1.8,0,11),new Vec3(1.5,0,11)];
    ...
    private pushChipsPosition:Vec3[] = [new Vec3(6,0,12),new Vec3(9.2,0,12),new Vec3(12.4,0,12)];                         // 重新发牌的位置.........
...
//this.guidePart();
    ...
    public reCreateChins() {
        ...
        for(let i = 0; i < 3; i++) {
            this.pushNodes[i].setPosition(this.pushChipsPosition[i]);
        }
