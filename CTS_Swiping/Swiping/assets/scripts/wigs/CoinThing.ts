...
export class CoinThing extends Component {
   ...
   public set InitScale(val:number) {
        this.node.setScale(v3(val, val, val));
   }
   ...
   public onUpdate(dt:number) {
       ...
       let currentPosy = this.initVector.y * this.currentLife;
