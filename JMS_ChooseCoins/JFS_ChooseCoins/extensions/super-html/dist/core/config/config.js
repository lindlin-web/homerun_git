  ...
  createConstants() {
    this.constants = new (class {
      constructor() {
        ...
        // 打包，过滤的文件格式
        this.pack_filter_extname_set = new Set([".ico", ".html", ".css", ".wasm"]);
      }
    })();
  }
  createDot() {
    ...
    this.inject_channel_adapter = [
      {
        ...
        b_out_zip: false,
        s_zip_name: out_name + "_Liftoff.zip",
      },
      {
        s_name: "tiktok",
        b_enable: true,
        b_html_compression: true,
        s_html_name: out_name + "_Tiktok.html",
        b_out_zip: false,
        s_zip_name: out_name + "_Tiktok.zip",
      },
      {
        s_name: "vungle",
        b_enable: true,
        b_html_compression: true,
        s_html_name: out_name + "_Vungle.html",
        b_out_zip: false,
        s_zip_name: out_name + "_Vungle.zip",
      },
      {
        s_name: "google",
        b_enable: true,
        b_html_compression: true,
        s_html_name: out_name + "_Google.html",
        b_out_zip: false,
        s_zip_name: out_name + "_Google.zip",
      },
      {
        s_name: "moloco",
        b_enable: false,
        b_html_compression: true,
        s_html_name: out_name + "_Moloco.html",
      },
      {
        s_name: "common",
        b_enable: true,
      ...
      },
      {
        ...
        b_enable: true,
        b_html_compression: true,
        s_html_name: out_name + "index.html",
      },
      {
        s_name: "applovin",
        b_enable: true,
        b_html_compression: true,
        s_html_name: out_name + "_Applovin.html",
      },
      {
        s_name: "ironsource",
        b_enable: true,
        b_html_compression: true,
        s_html_name: out_name + "_Ironsource.html",
      },
      {
        s_name: "mintegral",
        b_enable: true,
        b_html_compression: false,
        s_html_name:out_name + "_Mintegral.html",
        b_out_zip: false,
        s_zip_name: out_name + "_Mintegral.zip",
      },
      {
        s_name: "unity",
        b_enable: true,
        b_html_compression: true,
        s_html_name: out_name + "_Unity.html",
      },
      {
        s_name: "google_portrait",
      ...
      },
      {
        ...
        b_out_zip: false,
        b_html_compression: true,
        s_html_name: out_name + "_Facebook.html",
        s_zip_name: out_name + "_Facebook.zip",
      },
      {
        s_name: "pangle",
